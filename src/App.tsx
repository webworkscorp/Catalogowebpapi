...
import { type Product, categories, cartoons, portraits, footballers, combos, premiumGear } from './data';
    ...
    <div className="min-h-screen bg-[#0A0A0C] font-sans text-white overflow-x-hidden relative selection:bg-[#ff4b4b] selection:text-white">
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-10 relative z-10 pb-0">
        ...
        <footer className="mt-12 pb-10 flex flex-col items-center justify-center gap-4 text-center border-t border-white/5 pt-8">
          ...
          <a href="/mcp/config" target="_blank" rel="noopener noreferrer" className="mt-2 text-neutral-500 hover:text-white text-[10px] tracking-widest uppercase border border-neutral-800 px-3 py-1 rounded-sm transition-colors duration-200">
            Claude MCP Server
          </a>
        </footer>
